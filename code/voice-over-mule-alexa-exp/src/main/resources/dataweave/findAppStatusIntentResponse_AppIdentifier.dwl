...
else ("You have selected" ++ vars.vAppName ++ " application with the provided search name: " ++ searchTerm ++ ". The apps are " ++ speakAppListText ++ ". Please choose the app from the list or say the number associated with it. You can say search for, followed by thr app Number.")
++  
"</speak>"
---
{
